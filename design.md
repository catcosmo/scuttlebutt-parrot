...
Start app and choose decentralised connection without internet
![Start app and choose decentralised connection without internet](img/connect1.JPG)


Wait while app tries to find a node in the local network
![Wait while app tries to find a node in the local network](img/connect2.JPG)


No node was found, Select connection through internet.
![No node was found, Select connection through internet.](img/connect3.JPG)


Connection established successfully
![Connection established successfully](img/connect4.JPG)
...
Select *show thread* (speech bubble icon) from a post
